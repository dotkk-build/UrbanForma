...
public class ModClientEvents {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ...
            // 青色玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.CYAN_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.CYAN_GLASS_PANE.get(), RenderType.translucent());
            
            // 青色亮1玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.CYAN_LIGHT_1_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.CYAN_LIGHT_1_GLASS_PANE.get(), RenderType.translucent());
            
            // 青色亮2玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.CYAN_LIGHT_2_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.CYAN_LIGHT_2_GLASS_PANE.get(), RenderType.translucent());

            // 淡蓝色玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_GLASS_PANE.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_TINTED_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_TINTED_GLASS_PANE.get(), RenderType.translucent());
 
            // 淡蓝色亮1玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_1_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_1_GLASS_PANE.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_1_TINTED_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_1_TINTED_GLASS_PANE.get(), RenderType.translucent());

            // 淡蓝色亮2玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_2_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_2_GLASS_PANE.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_2_TINTED_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_BLUE_2_TINTED_GLASS_PANE.get(), RenderType.translucent());
            
            // 白色遮光玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.WHITE_TINTED_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.WHITE_TINTED_GLASS_PANE.get(), RenderType.translucent());

            // 亮灰1遮光玻璃
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_GRAY_1_TINTED_GLASS.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.LIGHT_GRAY_1_TINTED_GLASS_PANE.get(), RenderType.translucent());

            // 蓝色玻璃 2
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.BLUE_GLASS_2.get(), RenderType.translucent());
            net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(ModBlocks.BLUE_GLASS_2_PANE.get(), RenderType.translucent());
