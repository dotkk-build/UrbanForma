    ...
    public static final RegistryObject<CreativeModeTab> URBANFORMA_BASE_TAB = CREATIVE_MODE_TABS.register("a_1_urbanforma_base",
        () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ModBlocks.WHITE_VERTICAL_SLAB.get());
                output.accept(ModBlocks.WHITE_THIN_VERTICAL_SLAB.get());
                output.accept(ModBlocks.WHITE_CORNER_BLOCK.get());
                output.accept(ModBlocks.WHITE_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.LIGHT_GRAY_1_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.LIGHT_GRAY_2_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.LIGHT_GRAY_3_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.MEDIUM_GRAY_1_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.MEDIUM_GRAY_2_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.MEDIUM_GRAY_3_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.DARK_GRAY_1_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.DARK_GRAY_2_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.DARK_GRAY_3_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.DARK_GRAY_4_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.BLACKISH_GRAY_CEILING_FLOOR.get());
                ...
                output.accept(ModBlocks.BLACK_CEILING_FLOOR.get());
                output.accept(ModBlocks.DENSE_GRAY_WHITE_CEILING_FLOOR.get());
                output.accept(ModBlocks.IVORY_CEILING_FLOOR.get());
                output.accept(ModBlocks.SPAWN_COLOR_CEILING_FLOOR.get());
    ...
    public static final RegistryObject<CreativeModeTab> URBANFORMA_OTHER_TAB = CREATIVE_MODE_TABS.register("a_3_urbanforma_other",
        () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ModBlocks.WHITE_TINTED_GLASS_PANE.get());
                
                // 青色系列玻璃和玻璃片
                output.accept(ModBlocks.CYAN_GLASS.get());
                output.accept(ModBlocks.CYAN_GLASS_PANE.get());
                output.accept(ModBlocks.CYAN_TINTED_GLASS.get());
                output.accept(ModBlocks.CYAN_TINTED_GLASS_PANE.get());
                
                // 青色亮1玻璃和玻璃片
                output.accept(ModBlocks.CYAN_LIGHT_1_GLASS.get());
                output.accept(ModBlocks.CYAN_LIGHT_1_GLASS_PANE.get());
                output.accept(ModBlocks.CYAN_LIGHT_1_TINTED_GLASS.get());
                output.accept(ModBlocks.CYAN_LIGHT_1_TINTED_GLASS_PANE.get());
                
                // 青色亮2玻璃和玻璃片
                output.accept(ModBlocks.CYAN_LIGHT_2_GLASS.get());
                output.accept(ModBlocks.CYAN_LIGHT_2_GLASS_PANE.get());
                output.accept(ModBlocks.CYAN_LIGHT_2_TINTED_GLASS.get());
                output.accept(ModBlocks.CYAN_LIGHT_2_TINTED_GLASS_PANE.get());
                
                // 蓝色遮光玻璃和玻璃片
                output.accept(ModBlocks.BLUE_TINTED_GLASS.get());
                output.accept(ModBlocks.BLUE_TINTED_GLASS_PANE.get());
                
                // 亮灰系列玻璃和玻璃片
                output.accept(ModBlocks.LIGHT_GRAY_1_GLASS.get());
                output.accept(ModBlocks.LIGHT_GRAY_1_GLASS_PANE.get());
                output.accept(ModBlocks.LIGHT_GRAY_1_TINTED_GLASS.get());
                output.accept(ModBlocks.LIGHT_GRAY_1_TINTED_GLASS_PANE.get());
                output.accept(ModBlocks.LIGHT_GRAY_2_GLASS.get());
                output.accept(ModBlocks.LIGHT_GRAY_2_GLASS_PANE.get());
                output.accept(ModBlocks.LIGHT_GRAY_2_TINTED_GLASS.get());
                output.accept(ModBlocks.LIGHT_GRAY_2_TINTED_GLASS_PANE.get());
                output.accept(ModBlocks.LIGHT_GRAY_3_GLASS.get());
                output.accept(ModBlocks.LIGHT_GRAY_3_GLASS_PANE.get());
                output.accept(ModBlocks.LIGHT_GRAY_3_TINTED_GLASS.get());
                output.accept(ModBlocks.LIGHT_GRAY_3_TINTED_GLASS_PANE.get());
                ...
                // 淡蓝色系列玻璃和玻璃片
                output.accept(ModBlocks.LIGHT_BLUE_GLASS.get());
                output.accept(ModBlocks.LIGHT_BLUE_GLASS_PANE.get());
                output.accept(ModBlocks.LIGHT_BLUE_TINTED_GLASS.get());
                output.accept(ModBlocks.LIGHT_BLUE_TINTED_GLASS_PANE.get());
                
                // 淡蓝色亮1系列玻璃和玻璃片
                output.accept(ModBlocks.LIGHT_BLUE_1_GLASS.get());
                output.accept(ModBlocks.LIGHT_BLUE_1_GLASS_PANE.get());
                output.accept(ModBlocks.LIGHT_BLUE_1_TINTED_GLASS.get());
                output.accept(ModBlocks.LIGHT_BLUE_1_TINTED_GLASS_PANE.get());
                
                // 淡蓝色亮2系列玻璃和玻璃片
               output.accept(ModBlocks.LIGHT_BLUE_2_GLASS.get());
               output.accept(ModBlocks.LIGHT_BLUE_2_GLASS_PANE.get());
               output.accept(ModBlocks.LIGHT_BLUE_2_TINTED_GLASS.get());
               output.accept(ModBlocks.LIGHT_BLUE_2_TINTED_GLASS_PANE.get());
               ...
               // 黑灰和黑色系列玻璃和玻璃片
                ...
                // 蓝色玻璃系列
                output.accept(ModBlocks.BLUE_GLASS_2.get());
                output.accept(ModBlocks.BLUE_GLASS_2_PANE.get());
                
                // 红石钟系列
                output.accept(ModBlocks.REDSTONE_CLOCK_1S.get());
                output.accept(ModBlocks.REDSTONE_CLOCK_2S.get());
                output.accept(ModBlocks.REDSTONE_CLOCK_4S.get());
                output.accept(ModBlocks.REDSTONE_CLOCK_8S.get());
                output.accept(ModBlocks.REDSTONE_CLOCK_16S.get());
                output.accept(ModBlocks.REDSTONE_CLOCK_32S.get());
                
                // 白色防撞灯
                output.accept(ModBlocks.WHITE_ANTI_COLLISION_LIGHT.get());
                
                // 红色防撞灯
                output.accept(ModBlocks.RED_ANTI_COLLISION_LIGHT.get());
            })
            .build());
