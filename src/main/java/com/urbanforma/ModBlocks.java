...
public class ModBlocks {
    ...
    private static RegistryObject<Block> registerBorderWallBlock(String name) {
        return registerBlock(name, () -> new com.urbanforma.block.BorderWallBlock(BASIC_PROPERTIES));
    }
    private static RegistryObject<Block> registerThinBorderWallBlock(String name) {
        return registerBlock(name, () -> new com.urbanforma.block.ThinBorderWallBlock(BASIC_PROPERTIES));
    }
    
    private static RegistryObject<Block> registerVerticalSlabBlock(String name) {
        return registerBlock(name, () -> new VerticalSlabBlock(BASIC_PROPERTIES));
    }
    private static RegistryObject<Block> registerThinVerticalSlabBlock(String name) {
        return registerBlock(name, () -> new ThinVerticalSlabBlock(BASIC_PROPERTIES));
    }
    
    private static RegistryObject<Block> registerCornerBlock(String name) {
        return registerBlock(name, () -> new CornerBlock(BASIC_PROPERTIES));
    }
    
    private static RegistryObject<Block> registerRedstoneClockBlock(String name, int intervalInTicks) {
        return registerBlock(name, () -> new RedstoneClockBlock(BASIC_PROPERTIES, intervalInTicks));
    }
    
    private static RegistryObject<Block> registerAntiCollisionLightBlock(String name) {
        return registerBlock(name, () -> new AntiCollisionLightBlock(BASIC_PROPERTIES));
    }
    
    private static RegistryObject<Block> registerCeilingFloorBlock(String name) {
    ...
    // 白色边墙方块
    public static final RegistryObject<Block> WHITE_BORDER_WALL = registerBorderWallBlock("w_bb_border");
    
    // 白色细边墙方块
    public static final RegistryObject<Block> WHITE_THIN_BORDER_WALL = registerThinBorderWallBlock("w_bb_thin_border");
    
    // 白色粗竖半砖方块
    public static final RegistryObject<Block> WHITE_VERTICAL_SLAB = registerVerticalSlabBlock("w_vertical_slab");
    
    // 白色竖半砖方块（宽度8像素）
    public static final RegistryObject<Block> WHITE_THIN_VERTICAL_SLAB = registerThinVerticalSlabBlock("w_thin_vertical_slab");
    
    // 白色角方块
    public static final RegistryObject<Block> WHITE_CORNER_BLOCK = registerCornerBlock("w_corner");
    
    // 白色建筑板（天花板/地板）
    public static final RegistryObject<Block> WHITE_CEILING_FLOOR = registerCeilingFloorBlock("white_ceiling_floor");
    
    // 亮灰系列建筑板（天花板/地板）
    public static final RegistryObject<Block> LIGHT_GRAY_1_CEILING_FLOOR = registerCeilingFloorBlock("light_gray_1_ceiling_floor");
    public static final RegistryObject<Block> LIGHT_GRAY_2_CEILING_FLOOR = registerCeilingFloorBlock("light_gray_2_ceiling_floor");
    public static final RegistryObject<Block> LIGHT_GRAY_3_CEILING_FLOOR = registerCeilingFloorBlock("light_gray_3_ceiling_floor");
    
    // 中灰系列建筑板（天花板/地板）
    public static final RegistryObject<Block> MEDIUM_GRAY_1_CEILING_FLOOR = registerCeilingFloorBlock("medium_gray_1_ceiling_floor");
    public static final RegistryObject<Block> MEDIUM_GRAY_2_CEILING_FLOOR = registerCeilingFloorBlock("medium_gray_2_ceiling_floor");
    public static final RegistryObject<Block> MEDIUM_GRAY_3_CEILING_FLOOR = registerCeilingFloorBlock("medium_gray_3_ceiling_floor");
    
    // 暗灰系列建筑板（天花板/地板）
    public static final RegistryObject<Block> DARK_GRAY_1_CEILING_FLOOR = registerCeilingFloorBlock("dark_gray_1_ceiling_floor");
    public static final RegistryObject<Block> DARK_GRAY_2_CEILING_FLOOR = registerCeilingFloorBlock("dark_gray_2_ceiling_floor");
    public static final RegistryObject<Block> DARK_GRAY_3_CEILING_FLOOR = registerCeilingFloorBlock("dark_gray_3_ceiling_floor");
    public static final RegistryObject<Block> DARK_GRAY_4_CEILING_FLOOR = registerCeilingFloorBlock("dark_gray_4_ceiling_floor");
    public static final RegistryObject<Block> BLACKISH_GRAY_CEILING_FLOOR = registerCeilingFloorBlock("blackish_gray_ceiling_floor");
    public static final RegistryObject<Block> BLACK_CEILING_FLOOR = registerCeilingFloorBlock("black_ceiling_floor");
    public static final RegistryObject<Block> DENSE_GRAY_WHITE_CEILING_FLOOR = registerCeilingFloorBlock("dense_gray_white_ceiling_floor");
    public static final RegistryObject<Block> IVORY_CEILING_FLOOR = registerCeilingFloorBlock("ivory_ceiling_floor");
    public static final RegistryObject<Block> SPAWN_COLOR_CEILING_FLOOR = registerCeilingFloorBlock("spawn_color_ceiling_floor");
    ...
    // 白色遮光玻璃方块
    public static final RegistryObject<Block> WHITE_TINTED_GLASS = registerBlock("w_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());
    
    // 白色遮光玻璃片方块
    public static final RegistryObject<Block> WHITE_TINTED_GLASS_PANE = registerBlock("w_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    
    // 青色玻璃方块
    public static final RegistryObject<Block> CYAN_GLASS = registerBlock("bl_glass", () -> new com.urbanforma.block.UrbanGlassBlock());
    
    // 青色玻璃片方块
    public static final RegistryObject<Block> CYAN_GLASS_PANE = registerBlock("bl_glass_pane", () -> new com.urbanforma.block.UrbanGlassPaneBlock());
    
    // 青色遮光玻璃方块
    public static final RegistryObject<Block> CYAN_TINTED_GLASS = registerBlock("bl_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 青色遮光玻璃片方块
    public static final RegistryObject<Block> CYAN_TINTED_GLASS_PANE = registerBlock("bl_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    
    // 青色亮1玻璃方块
    public static final RegistryObject<Block> CYAN_LIGHT_1_GLASS = registerBlock("bl_g1_glass", () -> new com.urbanforma.block.UrbanGlassBlock());
    
    // 青色亮1玻璃片方块
    public static final RegistryObject<Block> CYAN_LIGHT_1_GLASS_PANE = registerBlock("bl_g1_glass_pane", () -> new com.urbanforma.block.UrbanGlassPaneBlock());
    
    // 青色亮1遮光玻璃方块
    public static final RegistryObject<Block> CYAN_LIGHT_1_TINTED_GLASS = registerBlock("bl_1_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 青色亮1遮光玻璃片方块
    public static final RegistryObject<Block> CYAN_LIGHT_1_TINTED_GLASS_PANE = registerBlock("bl_1_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    
    // 青色亮2玻璃方块
    public static final RegistryObject<Block> CYAN_LIGHT_2_GLASS = registerBlock("bl_g2_glass", () -> new com.urbanforma.block.UrbanGlassBlock());
    
    // 青色亮2玻璃片方块
    public static final RegistryObject<Block> CYAN_LIGHT_2_GLASS_PANE = registerBlock("bl_g2_glass_pane", () -> new com.urbanforma.block.UrbanGlassPaneBlock());
    
    // 青色亮2遮光玻璃方块
    public static final RegistryObject<Block> CYAN_LIGHT_2_TINTED_GLASS = registerBlock("bl_2_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 青色亮2遮光玻璃片方块
    public static final RegistryObject<Block> CYAN_LIGHT_2_TINTED_GLASS_PANE = registerBlock("bl_2_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    
    // 蓝色遮光玻璃方块 (复用 bl_g1.png 贴图)
    public static final RegistryObject<Block> BLUE_TINTED_GLASS = registerBlock("bl_blue_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 蓝色遮光玻璃片方块 (复用 bls_g1.png 贴图)
    public static final RegistryObject<Block> BLUE_TINTED_GLASS_PANE = registerBlock("bl_blue_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    
    // 淡蓝色玻璃方块 (bls_g3.png)
    public static final RegistryObject<Block> LIGHT_BLUE_GLASS = registerBlock("bls_g3_glass", () -> new com.urbanforma.block.UrbanGlassBlock());
    
    // 淡蓝色玻璃片方块
    public static final RegistryObject<Block> LIGHT_BLUE_GLASS_PANE = registerBlock("bls_g3_glass_pane", () -> new com.urbanforma.block.UrbanGlassPaneBlock());
    
    // 淡蓝色亮1玻璃方块 (bls_g3_1.png)
    public static final RegistryObject<Block> LIGHT_BLUE_1_GLASS = registerBlock("bls_g3_1_glass", () -> new com.urbanforma.block.UrbanGlassBlock());
    
    // 淡蓝色亮1玻璃片方块
    public static final RegistryObject<Block> LIGHT_BLUE_1_GLASS_PANE = registerBlock("bls_g3_1_glass_pane", () -> new com.urbanforma.block.UrbanGlassPaneBlock());
    
    // 淡蓝色亮1遮光玻璃方块 (复用 bls_g3_1.png 贴图)
    public static final RegistryObject<Block> LIGHT_BLUE_1_TINTED_GLASS = registerBlock("bls_g3_1_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 淡蓝色亮1遮光玻璃片方块 (复用 bls_g3_1.png 贴图)
    public static final RegistryObject<Block> LIGHT_BLUE_1_TINTED_GLASS_PANE = registerBlock("bls_g3_1_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    
    // 淡蓝色亮2玻璃方块 (bls_g3_2.png)
    public static final RegistryObject<Block> LIGHT_BLUE_2_GLASS = registerBlock("bls_g3_2_glass", () -> new com.urbanforma.block.UrbanGlassBlock());

    // 淡蓝色亮2玻璃片方块
    public static final RegistryObject<Block> LIGHT_BLUE_2_GLASS_PANE = registerBlock("bls_g3_2_glass_pane", () -> new com.urbanforma.block.UrbanGlassPaneBlock());
    
    // 淡蓝色亮2遮光玻璃方块 (复用 bls_g3_2.png 贴图)
    public static final RegistryObject<Block> LIGHT_BLUE_2_TINTED_GLASS = registerBlock("bls_g3_2_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 淡蓝色亮2遮光玻璃片方块 (复用 bls_g3_2.png 贴图)
    public static final RegistryObject<Block> LIGHT_BLUE_2_TINTED_GLASS_PANE = registerBlock("bls_g3_2_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    
    // 淡蓝色遮光玻璃方块 (复用 bls_g3.png 贴图)
    public static final RegistryObject<Block> LIGHT_BLUE_TINTED_GLASS = registerBlock("bl_light_blue_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 淡蓝色遮光玻璃片方块 (复用 bls_g3.png 贴图)
    public static final RegistryObject<Block> LIGHT_BLUE_TINTED_GLASS_PANE = registerBlock("bl_light_blue_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    ...
    // 亮灰1遮光玻璃方块
    public static final RegistryObject<Block> LIGHT_GRAY_1_TINTED_GLASS = registerBlock("lg_1_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // 亮灰1遮光玻璃片方块
    public static final RegistryObject<Block> LIGHT_GRAY_1_TINTED_GLASS_PANE = registerBlock("lg_1_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    ...
    // Light Gray 2 Tinted Glass Block
    public static final RegistryObject<Block> LIGHT_GRAY_2_TINTED_GLASS = registerBlock("lg_2_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // Light Gray 2 Tinted Glass Pane Block
    public static final RegistryObject<Block> LIGHT_GRAY_2_TINTED_GLASS_PANE = registerBlock("lg_2_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    ...
    // Light Gray 3 Tinted Glass Block
    public static final RegistryObject<Block> LIGHT_GRAY_3_TINTED_GLASS = registerBlock("lg_3_tinted_glass", () -> new com.urbanforma.block.UrbanTintedGlassBlock());

    // Light Gray 3 Tinted Glass Pane Block
    public static final RegistryObject<Block> LIGHT_GRAY_3_TINTED_GLASS_PANE = registerBlock("lg_3_tinted_glass_pane", () -> new com.urbanforma.block.UrbanTintedGlassPaneBlock());
    ...
    // 红石钟方块
    public static final RegistryObject<Block> REDSTONE_CLOCK_1S = registerRedstoneClockBlock("redstone_clock_1s", 20);
    public static final RegistryObject<Block> REDSTONE_CLOCK_2S = registerRedstoneClockBlock("redstone_clock_2s", 40);
    public static final RegistryObject<Block> REDSTONE_CLOCK_4S = registerRedstoneClockBlock("redstone_clock_4s", 80);
    public static final RegistryObject<Block> REDSTONE_CLOCK_8S = registerRedstoneClockBlock("redstone_clock_8s", 160);
    public static final RegistryObject<Block> REDSTONE_CLOCK_16S = registerRedstoneClockBlock("redstone_clock_16s", 320);
    public static final RegistryObject<Block> REDSTONE_CLOCK_32S = registerRedstoneClockBlock("redstone_clock_32s", 640);
    
    // 白色防撞灯
    public static final RegistryObject<Block> WHITE_ANTI_COLLISION_LIGHT = registerAntiCollisionLightBlock("white_anti_collision_light");
    
    // 红色防撞灯
    public static final RegistryObject<Block> RED_ANTI_COLLISION_LIGHT = registerAntiCollisionLightBlock("red_anti_collision_light");


    // 蓝色玻璃方块 (bla_g2.png)
    public static final RegistryObject<Block> BLUE_GLASS_2 = registerBlock("bla_g2", 
        () -> new com.urbanforma.block.UrbanGlassBlock());
    
    // 蓝色玻璃片方块
    public static final RegistryObject<Block> BLUE_GLASS_2_PANE = registerBlock("bla_g2_pane", 
        () -> new com.urbanforma.block.UrbanGlassPaneBlock());
